######################################################################
#       Eclectric Sheep's zshrc file, v0.1, based on:
...
PS1="$PR_YELLOW%n$PR_RED@$PR_BLUE%m%u$PR_RED:$PR_GREEN%2c$PR_RED%%$PR_NO_COLOR "
#RPS1="$PR_WHITE $PR_BLUE%D{%m-%d} $PR_WHITE// $PR_BLUE%D{%H:%M}$PR_WHITE $PR_NO_COLOR"
...
alias pwsafe='pwsafe -f ~/.pwsafe.dat -upE'
alias B='cd -'
